...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // We use env('STRIPE_KEY') here right inside the Blade file so Laravel injects it
        ...
        // Create card element WITH ZIP code enabled
    ...
    // Make switchMethod globally available for onclick handlers
