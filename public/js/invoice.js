 ...
 // --- State & Config ---
            ...
            function addRow() {
                ...
                let rowHtml = `
            <td class="p-3">
                <input type="text" name="items[${rowCount}][Item]" placeholder="Products"  class="w-full bg-transparent border border-gray-300 px-2 py-1 rounded-md focus:outline-none placeholder-gray-400 font-medium" />
            </td>
            <td class="p-3">
                <input type="number" name="items[${rowCount}][Quantity]" min="0" step="1" class="w-30 translate-x-10   bg-transparent border border-gray-300 px-2 py-1 rounded-md  focus:outline-none quantity-input" oninput="this.value = Math.max(0, Math.floor(this.value)); calculateRow(this)" />
            </td>
            <td class="p-3">
                <input type="number" name="items[${rowCount}][Rate]" min="0" step="1" class="w-30 translate-x-10 border border-gray-300 px-2 py-1 rounded-md  text-center bg-transparent focus:outline-none rate-input" oninput="this.value = Math.max(0, Math.floor(this.value)); calculateRow(this)" />
            </td>
        `;
            ...
            <td class="p-3  text-right font-medium text-gray-700 amount-display">
                ...
                <span class="row-amount border border-gray-300 px-2 py-1 rounded-md">0.00</span>
            </td>
